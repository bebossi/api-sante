...
// import { OrderController } from '../domain/Controller/OrderController'

// const routes = Router()
// const orderController = new OrderController()

// routes.post('/testMercadoPago', authMiddleware, orderController.testMercadoPago)
...
// routes.delete('/removeProduct', isAuth, authMiddleware, orderController.removeProduct)
...
// routes.get('/ordersByClient', authMiddleware, orderController.getOrdersByClient)
// routes.get(
...
// )
// routes.put('/statusOrder/:orderId', isAuth, isAdmin, orderController.statusOrder)
